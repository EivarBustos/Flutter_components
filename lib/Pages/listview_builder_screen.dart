...
Future fetchData() async{
   ...
   isLoading=false;
   setState(() {});
// esta linea if(scrollController.position.pixels+100<=scrollController.position.maxScrollExtent) return; permite cargar unicamente el final sin alteral las imagenes de arriba 
